...
var Parser = function () {
  ...
  (0, _createClass3.default)(Parser, [{
    ...
    key: 'then',
    value: function then(_cb, alwaysCheckSecond) {
      if (_cb === undefined) return Parser.zero();
      if (!(typeof _cb === "function")) _cb = function cb() {
        return _cb;
      };
      return new BindedParser(this, _cb, alwaysCheckSecond);
    }
