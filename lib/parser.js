  ...
  (0, _createClass3.default)(Parser, [{
    ...
    value: function satisfy(condition) {
      return this.bind(function (input) {
        return condition(input) ? Parser.result(input) : Parser.zero();
      });
    }
    ...
    value: function startsWith(value) {
      ...
      return this.firstIs(value[0]).bind(function (_) {
        return _this2.startsWith(value.slice(1)).bind(function (_) {
      ...
      return this.bind(function (head) {
        var sepParser = parser.bind(function (_) {
          return _this3.bind(function (next) {
            return Parser.result(next);
          });
        });
        return sepParser.many().bind(function (tail) {
          return Parser.result(util.toArray(head).concat(tail));
        });
...
var ResultParser = function (_Parser3) {
  ...
  function ResultParser(value) {
    ...
    var _this7 = (0, _possibleConstructorReturn3.default)(this, (ResultParser.__proto__ || (0, _getPrototypeOf2.default)(ResultParser)).call(this));
...
var BindedParser = function (_Parser4) {
  ...
  function BindedParser(parser, cb) {
    ...
    var _this8 = (0, _possibleConstructorReturn3.default)(this, (BindedParser.__proto__ || (0, _getPrototypeOf2.default)(BindedParser)).call(this));

    _this8.parser = parser;
    _this8.cb = cb;
    _this8.alwaysCheckSecond = alwaysCheckSecond;
    return _this8;
  }
...
var AddedParser = function (_Parser5) {
  ...
  function AddedParser(parser1, parser2) {
    ...
    var _this9 = (0, _possibleConstructorReturn3.default)(this, (AddedParser.__proto__ || (0, _getPrototypeOf2.default)(AddedParser)).call(this));

    _this9.parser1 = parser1;
    _this9.parser2 = parser2;
    return _this9;
  }
