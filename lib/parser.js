...
var Parser = function () {
  ...
  (0, _createClass3.default)(Parser, [{
    ...
    key: 'or',
    value: function or() {
      var parsers = [this].concat(Array.prototype.slice.call(arguments)).map(function (parser) {
        if (!(parser instanceof Parser)) return Parser.result(parser);
        return parser;
      });

      return new (Function.prototype.bind.apply(AddedParser, [null].concat((0, _toConsumableArray3.default)(parsers))))();
    }
    ...
    key: 'many',
    value: function many(type) {
      var _this = this;

      return this.then(function (c) {
        return _this.manyOrNone('', type).then(function (c1) {
          if (!c1) c1 = util.accumulator(typeof c === 'undefined' ? 'undefined' : (0, _typeof3.default)(c), type);

          if (c1.constructor === String) c1 = c + c1;else {
            c1.unshift(c);
          }
    ...
    key: 'copy',
    value: function copy() {
      var newParser = new this.constructor();
      return (0, _assign2.default)(newParser, this);
    }
  }]);
  return Parser;
}();
...
var BindedParser = function (_Parser4) {
  ...
  (0, _createClass3.default)(BindedParser, [{
    ...
    value: function process(input) {
      ...
      var nextParserFn = this.parserifyCb();
    ...
    value: function parserifyCb() {
      ...
      return function (value, input) {
        var nextParser = _this11.cb.bind(_this11)(value, input);
...
var AddedParser = function (_Parser5) {
  ...
  function AddedParser() {
    ...
    _this12.parsers = [].concat(Array.prototype.slice.call(arguments)).map(function (parser) {
      return parser.copy();
    });
    return _this12;
  }
  ...
  (0, _createClass3.default)(AddedParser, [{
    ...
    key: 'copy',
    value: function copy() {
      return new (Function.prototype.bind.apply(AddedParser, [null].concat((0, _toConsumableArray3.default)(this.parsers))))();
    }
  }]);
  return AddedParser;
}(Parser);
...
var LazyParser = function (_Parser7) {
  (0, _inherits3.default)(LazyParser, _Parser7);

  function LazyParser(parserFn) {
    (0, _classCallCheck3.default)(this, LazyParser);

    var _this14 = (0, _possibleConstructorReturn3.default)(this, (LazyParser.__proto__ || (0, _getPrototypeOf2.default)(LazyParser)).call(this));

    _this14.parserFn = parserFn.bind(_this14);
    return _this14;
  }

  (0, _createClass3.default)(LazyParser, [{
    key: 'getParser',
